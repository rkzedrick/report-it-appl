package com.rcts.ria.exception;
...
import static com.rcts.ria.exception.constant.ExceptionConstant.*;
...
public class ExceptionHandling implements ErrorController {
    ...
    public ResponseEntity<HttpResponse> accountDisabledException() {
        return createHttpResponse(HttpStatus.valueOf(BAD_REQUEST), ACCOUNT_DISABLED);
    }

    @ExceptionHandler(BadCredentialsException.class)
    public ResponseEntity<HttpResponse> badCredentialsException() {
        return createHttpResponse(HttpStatus.valueOf(BAD_REQUEST), INCORRECT_CREDENTIALS);
    }
